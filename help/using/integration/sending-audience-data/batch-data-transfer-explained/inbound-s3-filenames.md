...
Potete [scaricare](assets/ftp_dpm_1234_1445374061.overwrite) il file di esempio se desiderate ulteriori esempi. Il file è stato salvato con l&#39;estensione `.overwrite`. Aprite l’applicazione con un semplice editor di testo.

## Dimensioni file accettate {#accepted-file-sizes}

Considerare le cifre riportate di seguito per l&#39;elaborazione più rapida/rapida dei file e per i limiti di dimensione dei file quando si inviano dati a una directory [!DNL Audience Manager] / [!DNL Amazon S3].
