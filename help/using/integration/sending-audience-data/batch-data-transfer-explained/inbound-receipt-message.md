...
<table id="table_93076D46AC50411395E72B9B987E99BE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Numero di record in cui nessuno dei segnali sulla linea viene mappato su una caratteristica di Audience Manager. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Numero totale di segnali inutilizzati per tutti gli utenti in tutti i file in entrata (coppie chiave/valore che non sono state mappate sulle caratteristiche di Audience Manager). Nella maggior parte dei casi, questo significa che Audience Manager non ha regole definite per il segnale. </p> </td> 
  </tr> 
  <tr> 
