  ...
  <tr> 
   ...
   <td colname="col2"> <p>Un ID che informa <span class="keyword"> Audience Manager</span> se un file di dati contiene gli ID utente o gli ID Android o iOS personali. Accetta le seguenti opzioni: </p> 
    <ul id="ul_818EB3EB2E5543F0B048BCEBB6699562"> 
     ...
     <li id="li_1955911BA11F4F458227B77F383F25A3"> <b></b> ID Android (GAID): Usa l'ID 20914 in un nome file di dati se contiene un ID Android. Ad esempio, <code>..ftp_dpm_20914_123456789.sync</code> informa <span class="keyword"> Audience Manager</span> che il file di dati contiene solo ID Android. </li> 
