...
>[!NOTE]
>
>Gli elementi di stile (`monospaced text`, *corsivo*, parentesi quadre `[ ]` `( )`, ecc.) in questo documento indicare gli elementi di codice e le opzioni. Per ulteriori informazioni, consulta le [convenzioni di stile per codice ed elementi di testo](../../../reference/code-style-elements.md).
...
<table id="table_1EA97D75004148CE85F702427DB7E97A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>ID destinazione. </p> <p>Nell'Audience Manager </span> di <span class="keyword">, una destinazione è l'istanza dell'integrazione in cui è possibile mappare i segmenti di destinazione. I clienti possono avere più destinazioni, a seconda dei requisiti aziendali. </p> </td> 
  </tr> 
  <tr> 
