...
seo-description: Panoramica di alto livello sul modo in cui Audience Manager scambia informazioni con altri fornitori e sistemi di dati.
...
La scelta del metodo di integrazione corretto dipende dalla combinazione di requisiti aziendali e capacità tecniche del partner dati. Audience Manager scambia informazioni sui visitatori con altri fornitori di dati tramite uno dei seguenti metodi:
 ...
 <tr class="strow">
  ...
  <td class="stentry"> 
   <ul id="ul_F251AFF8A2FA49D0849E36D7FAE87DE7"> 
    ...
    <li id="li_1C1F346CB7BD40508AA5A6918C6B8514"> Riduce il numero di chiamate HTTP dalla pagina. Un numero minore di chiamate consente di preservare l'esperienza utente. </li>
...
* **** Considerazioni Tecniche: La distribuzione dei dati dipende dalle capacità tecniche del partner dati. Audience Manager può inviare/ricevere dati in tempo reale dal browser o mediante aggiornamenti in batch attraverso processi di comunicazione da server a server offline.
...
1. La terza parte restituisce ad Audience Manager le informazioni sul segmento di tale utente.
...
Per informazioni che descrivono i tempi di elaborazione dei trasferimenti di file da server a server ([!UICONTROL S2S]) in entrata e in uscita da Audience Manager, consultate [Reporting and File Transfer Time-Frame Guidelines](../reference/reporting-file-transfer-timeframe.md)(Linee guida sui tempi di trasferimento dei file e dei rapporti).
