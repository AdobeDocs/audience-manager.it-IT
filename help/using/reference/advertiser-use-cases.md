  ...
  <tr> 
   <td colname="col1"> 
    <ul id="ul_F75C5E36CBD84EE7942988CEECE2DA5E"> 
     <li id="li_9485DFA2168C4FC5A7CF4B3EAA7EBE08">Crea un unico repository di audience per unificare i clienti o i dati dei potenziali clienti tra impression di visualizzazione, dati di acquisizione in loco, comportamento del sito, iniziative e-mail e promozioni. </li> 
     <li id="li_584F7F550A9446F19542EF13A0F5D81B">Comprendere gli attributi utente per migliorare le attività di acquisto di contenuti multimediali. </li> 
    </ul> </td> 
   <td colname="col2"> Un archivio dati cliente unificato consente di migliorare l'individuazione del pubblico, la pianificazione aziendale e fornisce una comprensione approfondita dei segmenti di pubblico. </td> 
   <td colname="col3"> Per la pianificazione trimestrale dei supporti di visualizzazione, evidenzia comportamenti univoci da parte dell'audience tra i profili potenziali e sposta il budget in un segmento o in un'origine di magazzino specifica. </td> 
  </tr> 
 </tbody> 
</table>
...
La documentazione [Modelli](../features/algorithmic-models/understanding-models.md) contiene informazioni dettagliate sul processo di modellazione [!DNL Audience Manager] algoritmica.
  ...
  <tr> 
   <td colname="col1"> 
    <ul id="ul_6B69497AA7F543249FF820B1D5DC604F"> 
     <li id="li_7022E99BC3C6475988B8424528A221A8">Sfruttate il comportamento del sito, i dati offline, i dati di terze parti, le metriche delle campagne per creare profili di audience preziosi. </li> 
     <li id="li_DBD50B14B3D34D9AB72C42E245406FE8">Per aumentare il raggio di azione, puoi modellare questi segmenti rispetto ad altre origini dati. </li> 
    </ul> </td> 
   <td colname="col2"> 
    <ul id="ul_CC5448D2EA0646D4AF3547E81DE31FDE"> 
     <li id="li_8F11E40026404C1380F26F6D03952C8E">Identifica nuove audience con comportamenti e profili che rispecchiano l'audience originale. </li> 
     <li id="li_5F67AD849EC145DBB1E52A92BBE2CEE3">Consente di effettuare ricerche in base ai dati personali e ad altri dati di terze parti a cui si ha accesso. Questo consente di individuare e identificare i punti dati più influenti per i profili di pubblico di alto valore. </li> 
    </ul> </td>
   <td colname="col3"> 
...
<table id="table_26697DC988BD4A6493B4867B903132D7"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Riavviate i visitatori su siti di advertiser o partner tramite un DSP per aumentare l'efficacia del targeting degli annunci. </td> 
   <td colname="col2"> 
    <ul id="ul_CD4D116AD6FB4A65841A8962B27577C4"> 
     <li id="li_59ED86AE57844EE19D65276914F90EF3">Allineare i punti dati dell'analisi con gli annunci pubblicitari visualizzati. </li> 
...
## Utilizza i dati dei partner per creare offerte speciali per i clienti attuali
  ...
  <tr> 
   <td colname="col1"> 
    <ul id="ul_AEE9F72C1E8C4B6B9A2784ECB5403B61"> 
     <li id="li_F5155FA10A664E0AB6BDCCFD2BB95314">Offri ai clienti tariffe speciali basate sui dati dei segmenti forniti dai partner commerciali. </li> 
     <li id="li_679868485491412980FDF897A9BB64A4">Per i clienti nel segmento, rinforzate questa offerta speciale tramite il marketing e-mail. </li> 
    </ul> </td> 
   <td colname="col2"> 
    <ul id="ul_0C0A0960604143B3A54FA61002ABB233"> 
     <li id="li_CA8748A00624479A8E15437AD9A1EC54">Migliorare la gestione delle offerte e i tassi di conversione sfruttando i dati dei partner strategici. </li> 
     <li id="li_00B0A3039BBD4DF3814C64539C83E4DA">Suddividi i silos di dati e l'organizzazione con sistemi progettati per gestire e ottimizzare le iniziative di marketing multicanale. </li> 
    </ul> </td> 
   <td colname="col3"> 
...
## Utilizza i dati CRM per creare offerte speciali per i clienti attuali
...
## Eseguire il marketing delle e-mail con il comportamento locale e i dati attuali dei clienti
...
<table id="table_FAAE5C97107244A1B5179DF0FEC604D1"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Sfruttate i dati dei visitatori esistenti e di terze parti per ottimizzare e personalizzare l'esperienza digitale di un cliente. </p> </td> 
...
<table id="table_9253B663D0F8458CBB43C38C212689CF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Crea e gestisci un'unica tassonomia dati di prime parti per la distribuzione tra piattaforme di monetizzazione. </p> </td> 
   <td colname="col2"> 
