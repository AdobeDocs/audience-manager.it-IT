 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Lunedì, un visitatore identificato nel database CRM come visitor ABC effettua l'accesso, che avvia una sincronizzazione ID lato client. <span class="keyword"> Audience Manager</span> memorizza la mappatura del visitatore ABC al visitatore <span class="keyword"> Audience Manager</span> 123. </p> <p>Martedì, il database CRM trasferisce un file di dati (<span class="filepath"> .sync</span>) al <span class="keyword"> server </span>Audience Manager con il seguente record: </p> <p> 
     <ul class="simplelist"> 
      <li><code> ABC "gender"="maschio","luxury_shopper"="yes"</code> </li> 
     ...
     <ul id="ul_7616432BF9874E7D94F3101C71F73C81"> 
      ...
      <li id="li_62E085FC184D41C3863B1CE832F77946"> Associa le caratteristiche <code> maschili</code> e <code> luxury_shopper</code> al profilo visitatore 123. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Lunedì, il database CRM invia un file di dati (<span class="filepath"> .sync</span>) al server <span class="keyword"> Audience Manager</span> con il seguente record: </p> <p> 
     <ul class="simplelist"> 
      <li><code> DEF "gender"="femmina","wine_entusiast"="yes"</code> </li> 
     ...
     <ul class="simplelist"> 
      <li><code> DEF "gender"="femmina","wine_entusiast"="yes","dma"="paris"</code> </li> 
    ...
    <ul id="ul_E853DA091D9042DAB19774383841D3A3"> 
     ...
     <li id="li_9CEE7A7B1A954FF6AEEBF8844074CFBB">Associa le caratteristiche <code> femmina</code>, <code> paris</code>e <code> wine_entusiasta</code> al profilo visitatore 456. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>Caso 3</b> </p> </td> 
   <td colname="col2"> <p>Lunedì, il server <span class="keyword"> Audience Manager</span> riceve due file con i seguenti record: </p> <p> <code> File .sync</code> contenente: </p> <p> 
     <ul class="simplelist"> 
      <li><code> GHI 123456789</code> </li> 
     </ul> </p> <p> <code> .overwrite</code> file contenente: </p> 
    <ul id="ul_084AE448C60447ACA9B1E0C30EAA3E3E"> 
     <li id="li_C68B7BBFE7CA4D22B606D939E32FF4FB"><code> GHI "gender"="maschio" "wine_entusiast"="no"</code> </li> 
     <li id="li_FDBCAAFBD606477E8690EA80AD455A81"><code> JKL "gender"="femmina" "wine_entusiast"="yes"</code> </li> 
    ...
    <ul id="ul_4D083CEA7F1B4F6BBBBB841C21293751"> 
     ...
     <li id="li_CCEF77240E5C4A03AAE347440D73F0BB">Associa le caratteristiche <code> femminile</code> e <code> wine_entusiasta</code> al profilo dell'ID visitatore 789. </li> 
     <li id="li_273F8FD7C6214488A26AAFFA6DE043E5">Ignora l’associazione di caratteristiche per il GHI visitatore, poiché il relativo ID è stato sincronizzato solo nel batch corrente. Per associare le caratteristiche con il GHI visitatore, è necessario includerle in file <code> .overwrite</code> futuri. </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_E89301D815174D45B9B238F2CDE6CCC6"> 
      <li id="li_FA841FEEC0534AD59D1AB61DD5B9DEC4">Contenuto del file .sync <code></code> Giorno 1: <code> visitor123 = a,b,c</code> </li> 
      <li id="li_0E1A57B04D26481C8C41EBA63ACBEFE0">Giorno 2 <code> .overwrite</code> file contents: <code> visitor123 = c,d,e</code> </li> 
      <li id="li_497A5604AD9A49A2ADE548C7CE158F0E"> L'ID del profilo visitatore 123 Giorno 3 contiene <code> c,d,e </code> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_8271C9796BD040E4B8DC64DCE4FE2AD3"> 
      <li id="li_347959BDE83549F794E6661C95097891">Contenuto del file .sync <code></code> Giorno 1: <code> visitor123 = a,b,c </code> </li> 
      <li id="li_B25D96526DE94171A3A5DC8DB7A19415">Contenuto del file .sync <code></code> Giorno 2: <code> visitor123 = c,d,e</code> </li> 
      <li id="li_6E17809D49C74F4991B0B445469055E6">L’ID del profilo visitatore 123 Giorno 3 contiene <code> a,b,c,d,e</code> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Esistono due componenti di base di un file di dati: Un ID utente univoco (UUID) e i dati del profilo, in genere sotto forma di coppie o codici chiave-valore. L’UUID distingue tra maiuscole e minuscole. In genere, i dati relativi al profilo o al valore chiave non fanno distinzione tra maiuscole e minuscole.
