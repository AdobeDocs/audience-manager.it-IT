...
* Il carattere [!DNL ASCII] `%01` non stampabile separa i valori.
...
Descrive le variabili di configurazione utilizzate per passare da [!UICONTROL declared IDs] a [!UICONTROL DIL] tramite [!DNL Audience Manager.]
