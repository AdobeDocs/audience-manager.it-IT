...
Con, [!UICONTROL Trait Recommendations]quando create o modificate un segmento in [Segment Builder](segment-builder.md)(Generatore segmenti), potete ottenere raccomandazioni su caratteristiche aggiuntive che potete includere, che sono simili alle caratteristiche nella regola del segmento. Aggiungi le caratteristiche consigliate al segmento per aumentare il pubblico di destinazione.
...
1. Nel menu a discesa **Caratteristiche** , aggiungi almeno una caratteristica alla regola del segmento.
