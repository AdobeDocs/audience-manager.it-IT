...
Le caratteristiche e i segmenti scelti per la classificazione di utenti tipo e pubblico sono soggetti all&#39;Audience Manager [Controlli di accesso basati sul ruolo](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/administration-overview.html).
