...
<table id="table_366914EEDA294636A580F706AFC57ACC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html?lang=it" format="https" scope="external"> cookie Audienci Manager</a> </p> </td> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Scopri perché <span class="wintitle"> file di registro fruibili</span> è il metodo consigliato per importare i file di registro DCM nell'Audience Manager <span class="keyword"></span> e come iniziare a utilizzare questa funzione. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>È stato aggiunto il passaggio 7, relativo alle operazioni da eseguire per abilitare <span class="wintitle"> file di registro utilizzabili</span> dopo la configurazione dell'importazione del file di dati DCM nell'Audience Manager <span class="keyword"></span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../integration/integration-other-solutions/aam-target-integration.md"> Integra L'Audience Manager Con Target</a> </p> </td> 
...
<table id="table_A56DCFF49B78467B9600A8CE8F608094"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"><i>Questa funzionalità è stata dichiarata obsoleta.</i> <p>Una nuova configurazione per controllare il modo in cui i dati vengono inviati all'Experience Cloud <span class="keyword"> Device Co-op</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>In <span class="keyword"> Audience Manager</span> è possibile utilizzare diversi tipi e origini di modelli. <span class="wintitle"> Audience Lab</span> offre un modo semplice per confrontare i tassi di conversione dei tuoi clienti, tra i tuoi modelli attivi. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../integration/sending-audience-data/batch-data-transfer-explained/batch-data-transfer-overview.md"> Invia dati batch ad Audience Manager Overview</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stato aggiunto un nuovo documento sul motivo per cui l'Audience Manager </span> di <span class="keyword"> effettua chiamate al dominio <code> demdex.net</code>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html?lang=it" format="https" scope="external"> cookie Audienci Manager</a> </p> </td> 
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/more-resources/dns-prefetch.html?lang=it" format="https" scope="external"> Utilizzo di prefetch DNS con diverse soluzioni Experience Cloud</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/api-swagger-migration.md"> Audience Manager di migrazione del codice API</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stata aggiunta una nuova voce che descrive l'ID organizzazione </span> dell'Experience Cloud <span class="keyword"> </span> <span class="wintitle">, incluse informazioni su come trovarlo. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
