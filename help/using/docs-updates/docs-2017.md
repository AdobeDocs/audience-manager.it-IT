...
<table id="table_366914EEDA294636A580F706AFC57ACC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Cookie Audience Manager</a> </p> </td> 
...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A scopo di riferimento, abbiamo aggiunto gli attributi riservati <code> d_dst_filter</code> e <code> d_rs</code> alla documentazione <code> d_</code> attributi. Consigliamo di non creare caratteristiche che utilizzano attributi riservati. Adobe può modificare gli attributi riservati in qualsiasi momento. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>La qualificazione delle caratteristiche, o la realizzazione delle caratteristiche, viene trattata in modo diverso nell’Audience Manager, a seconda del tipo di caratteristica. Questo documento descrive le particolarità di qualifica per ogni tipo di caratteristica. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Attributi supportati per le chiamate API DCS</a> </p> </td> 
   <td colname="col2"> <p>Aggiunto <code> d_cts</code> come parametro opzionale nell’elenco delle chiavi disponibili per le richieste DCS. Contatta il tuo consulente Adobe Audience Manager o l’Assistenza clienti per abilitarlo. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nuovi contenuti su come inviare segmenti Audience Manager ad Analytics. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../features/algorithmic-models/understanding-models.md#update-schedule"> Pianificazione di aggiornamento per modelli e caratteristiche algoritmiche</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stato aggiunto il passaggio 7, su cosa fare per abilitare <span class="wintitle"> File di registro fruibili</span> dopo aver impostato l’importazione del file di dati DCM in <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Il nuovo contenuto descrive come inviare segmenti di Audienci Manager a Target. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Rivisto con nuove definizioni che tengono conto di come <span class="wintitle"> Regole di unione profili</span> influenzare i numeri di reporting. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/manage-folder-traits.md#edit-folder-trait"> Modificare una caratteristica cartella</a> </p> </td> 
   <td colname="col2"> <p> Il <b><span class="uicontrol"> Modifica</span></b> workflow consente di modificare l'origine dati per le caratteristiche della cartella. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> Dati sulle caratteristiche e sulle popolazioni dei segmenti nel Generatore di segmenti</a> </p> </td> 
   <td colname="col2"> <p>Una metrica è stata modificata in <span class="wintitle"> Popolazione di caratteristiche totale</span> da <span class="wintitle"> Realizzazioni di caratteristiche univoche</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder.md"> Rimuovere caratteristiche da un segmento</a> </p> </td> 
   <td colname="col2"> <p>Istruzioni su come rimuovere le caratteristiche da un segmento utilizzando <span class="wintitle"> Generatore di segmenti</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md"> Disattivazione dei feed dati: perché si verifica e come rispondere</a> </p> </td> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Una nuova sezione nella nostra documentazione, che evidenzia diversi casi d’uso per <span class="wintitle"> Audience Lab</span> funzionalità. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab-use-cases.md#compare-models"> Confrontare modelli in Audience Lab</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab-use-cases.md#testing-creatives"> Verifica di creativi tra le destinazioni</a> </p> </td> 
   <td colname="col2"> <p>Utilizzare <span class="wintitle"> Audience Lab</span> per misurare il numero di conversioni che un creativo sta guidando tra diverse destinazioni. Questo caso d’uso consente inoltre di misurare le conversioni del contenuto creativo rispetto alle conversioni naturali. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-profile-merge.md"> Domande frequenti sulle regole di unione profili</a> </p> </td> 
   <td colname="col2"> <p>È stata aggiunta una nuova domanda frequente per rispondere alle domande comuni <span class="wintitle"> Regola di unione profili</span> e sul grafico dei dispositivi. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Le chiamate di risposta DCS HTTP ora contengono <code> tid</code> campo. Utilizza questo campo a scopo di debug in caso di problemi. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Sono state aggiunte informazioni sulle posizioni dell’ambiente di produzione e dell’ambiente beta per il servizio Amazon S3. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2" morerows="2"> <p>È stata aggiunta una nota che chiarisce che i periodi di look-back di 7 e 30 giorni sono disponibili solo per la domenica <b><span class="uicontrol"> Data fino a</span></b> date. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Contenuto rivisto per indicare quanto segue: </p> 
    <ul id="ul_99C2ACF7B28F442B8F66A40525F1CAE3"> 
     ...
     <li id="li_5012C420AC544B858246598575E59D8C">Prima del caricamento, i file devono essere compressi con Gzip e disporre di un <code> .gz</code> estensione file. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> Dati sulle caratteristiche e sulle popolazioni dei segmenti nel Generatore di segmenti</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stato aggiunto un nuovo documento sui motivi per cui <span class="keyword"> Audience Manager</span> effettua chiamate al <code> demdex.net</code> dominio. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Cookie Audience Manager</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Attributi supportati per le chiamate API DCS</a> </p> </td> 
   <td colname="col2"> <p>Aggiornamento dei prefissi delle variabili chiave con <code> _p</code>, che identifica i parametri privati in Audience Manager. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-dashboard.md"> Vista elenco caratteristiche</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics"> Metriche del pubblico di riferimento</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Questa sezione contiene contenuti nuovi e rivisti per supportare <span class="wintitle"> Collegamento profilo</span> e di terze parti. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Elemento nome file facoltativo aggiunto <code> PID-ALIAS</code> in uscita. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/more-resources/dns-prefetch.html" format="https" scope="external"> Utilizzo di prefetch DNS con diverse soluzioni di Experience Cloud</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stata rivista la descrizione e sono stati aggiunti collegamenti correlati alla sezione <code> containerSNID</code> proprietà di <code> DIL.create</code>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics"> Metriche del pubblico di riferimento</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stata aggiunta una nuova voce che descrive <span class="keyword"> Experience Cloud</span> <span class="wintitle"> ID organizzazione</span>, incluse informazioni su come trovarlo. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
   ...
   <td colname="col2"> <p>Aggiornato per includere <code> DPUUIDS</code> macro. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Collegamenti a [!DNL Audience Manager] note sulla versione e modifiche alla documentazione. Per un archivio delle modifiche precedenti in [!DNL Experience Cloud] livello, vedere [Note sulle versioni precedenti](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) sezione.
