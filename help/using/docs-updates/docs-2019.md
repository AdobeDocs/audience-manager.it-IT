...
| [Strumenti di gestione in blocco](/help/using/reference/bulk-management-tools/bulk-management-intro.md) | È stata rilasciata una nuova versione del foglio di lavoro Bulk Management che funziona sui sistemi operativi MacOS e Microsoft Windows e supporta l’accesso a Experience Cloud. |
