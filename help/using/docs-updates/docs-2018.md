...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Per i clienti che utilizzano  Audience Manager e  Adobe Analytics: L'interfaccia utente del Audience Manager  non consente di eliminare le origini dati create automaticamente dalle suite di rapporti di Analytics. Utilizzare il <a href="https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html" format="https" scope="external"> servizio di base</a> per annullare la mappatura di queste origini dati. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A partire dalla versione 8.0, <span class="wintitle"> DIL</span> ha una dipendenza su <a href="https://docs.adobe.com/content/help/it-IT/id-service/using/home.html" format="https" scope="external"><span class="keyword"> Adobe Experience Platform Identity Service</span></a>, versione 3.3 o successiva. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md"> Informazioni sulla Data Integration Library (DIL)</a> </p> </td> 
   <td colname="col2"> <p>Modificato <a href="../dil/dil-overview.md"> Ottenimento e implementazione del codice DIL</a> per tenere conto del fatto che <span class="keyword">  Adobe Experience Platform Launch</span> è lo strumento preferito per la distribuzione del codice nell'Experience Cloud <span class="keyword">  </span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_728845C945394BCC8689ACF50EDDB577"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Con l’ottimizzazione del pubblico per gli editori, i publisher possono individuare potenziali opportunità prestazionali per segmenti Audience Manager sui contenuti che possiedono o gestiscono. Questi rapporti combinano dati sulle prestazioni delle campagne a livello di registro con metriche  Audience Manager per informare l'audience sulle ottimizzazioni e sulle opportunità di monetizzazione. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_2D7B56FFB0134D18894E0493043C32BD"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Le richieste di GET hanno una lunghezza massima di 8K. Per ulteriori informazioni sui metodi API GET e POST, visitare questa pagina. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Prima di leggere le specifiche del Audience Manager , vi consigliamo di consultare il materiale  Experience Cloud per il Regolamento generale sulla protezione dei dati (GDPR), collegato da questa pagina. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../overview/data-security-and-privacy/data-privacy-requests.md"> GDPR in Audience Manager</a> </p> </td> 
   <td colname="col2"> <p>Il presente documento illustra i dettagli tecnici relativi al Regolamento generale sulla protezione dei dati (General Data Protection Regulation, GDPR) per  Audience Manager e illustra come inviare le richieste GDPR a  Audience Manager. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Per aiutare i nostri clienti ad automatizzare le richieste GDPR,  Audience Manager notifica ai nostri partner di attivazione le richieste di cancellazione da Data Subject inviando loro informazioni non segmentate (o rimuovendo segmenti). </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9166897029124C6782E0DE3D816CEA49"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Gli utenti inizieranno a qualificarsi per una caratteristica basata su regola circa 4 ore dopo che <a href="../features/traits/create-onboarded-rule-based-traits.md#create-rules-based-or-onboarded-traits"> avrai creato la caratteristica</a> nell'interfaccia utente. Leggere il documento per ulteriori informazioni sulla qualifica delle caratteristiche. </p> </td> 
  </tr> 
  <tr> 
