...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Include una nuova voce sulla white list <span class="keyword"> Audience Manager</span> Indirizzi IP e FTP. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Documentazione che descrive un nuovo metodo DIL che consente di inviare dati a <span class="keyword"> Audience Manager</span> da Universal Analytics di Google. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> gestisce gli stati di autenticazione dell’ID visitatore <code> UNKNOWN</code> e <code> LOGGED_OUT</code> allo stesso modo. Il documento fornisce ulteriori informazioni su come gestiamo <code> setCustomerID</code> chiamate evento. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Per un elenco completo delle opzioni disponibili, consulta questo documento. <span class="keyword"> Audience Manager</span> ID. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-audience-lab.md"> Domande frequenti su Audience Lab </a> </p> </td> 
   <td colname="col2"> <p>Domande frequenti su <span class="wintitle"> Audience Lab</span> funzionalità. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nuovo contenuto che descrive le funzioni di <span class="wintitle"> Destinazioni</span> pagina di destinazione. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">È stata aggiunta la possibilità di proteggere il trasferimento di dati in uscita in tempo reale tramite il protocollo OAuth 2.0. Contatta il tuo <span class="keyword"> Adobe Audience Manager</span> consulente per iniziare. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Rivisto per notare che <code> GA.init()</code> non funziona con la versione più recente del codice di analisi di Google, <code> analytics.js</code>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <i>Questa funzione è stata rimossa.</i><p>Rivisto per includere ulteriori informazioni su <span class="keyword"> Adobe Experience Cloud Device Co-op</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Panoramica generale del <span class="wintitle"> Data Information Library</span> (DIL). </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Contenuto aggiornato che spiega perché DIL utilizza <code> GET</code> e <code> POST</code> metodi per inviare dati in una chiamata evento. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stato aggiornato il <span class="wintitle"> Audience Optimization</span>rapporti con Cross Channel Conversion, Role-Based Access Control, Conversion Groups e il rapporto Reported Conversion Traits. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Il <span class="wintitle"> Conversione tra canali</span> opzione in <span class="wintitle"> Audience Optimization</span> nei rapporti puoi attribuire conversioni offline alle impression online o ai clic. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Rimosso da <span class="keyword"> Audience Manager</span> a settembre 2017. Spostato in <span class="keyword"> Analytics</span> documentazione. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Descrive come <span class="wintitle"> Audience Marketplace</span> i provider di dati disattivano il feed di un abbonato. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md">Che cosa accade dopo la disattivazione dei miei feed dati da parte di un fornitore?</a> </p> </td> 
   <td colname="col2"> <p>Descrive che cosa <span class="wintitle"> Audience Marketplace</span> l’acquirente dei dati può aspettarsi che un provider revochi l’accesso a un feed di dati. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> Codici errore DCS, messaggi ed esempi </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="1"> <p>Testo rivisto per includere <code> d_mid</code> variabile. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stata aggiunta una nuova descrizione per <span class="wintitle"> Tipo di evento</span>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Nuova documentazione che elenca e definisce gli elementi in un <span class="wintitle"> Audience Marketplace</span> rapporto di fatturazione. </p> </td> 
  </tr> 
  <tr> 
