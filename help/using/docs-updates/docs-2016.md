---
description: Un elenco di documentazione nuova e rivista sugli Audienci Manager rilasciata nel 2016. Include piccoli aggiornamenti o modifiche alla guida all’Audience Manager che potrebbero non essere inclusi nelle note sulla versione di Experience Cloud.
...
Un elenco di documentazione nuova e rivista sugli Audienci Manager rilasciata nel 2016. Include piccoli aggiornamenti o modifiche alla guida all’Audience Manager che potrebbero non essere inclusi nelle note sulla versione di Experience Cloud.
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> gestisce gli stati di autenticazione dell’ID visitatore <code> UNKNOWN</code> e <code> LOGGED_OUT</code> allo stesso modo. Il documento fornisce ulteriori informazioni su come gestire <code> setCustomerID</code> chiamate evento. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Fai riferimento a questo documento per un elenco completo dei <span class="keyword"> Audience Manager</span> ID. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-audience-lab.md"> Domande frequenti su Audience Lab </a> </p> </td> 
   <td colname="col2"> <p>Domande frequenti sul <span class="wintitle"> Audience Lab</span> funzionalità. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">Aggiunta la funzionalità di protezione del trasferimento dati in uscita in tempo reale tramite il protocollo OAuth 2.0. Contatta il tuo <span class="keyword"> Adobe Audience Manager</span> consulente per iniziare. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Rivisto quanto segue <code> GA.init()</code> non funziona con l’ultima versione del codice di analisi di Google, <code> analytics.js</code>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <i>Questa funzione è stata rimossa.</i><p>Aggiornato per includere ulteriori informazioni sul <span class="keyword"> Adobe Experience Cloud Device Co-op</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Panoramica generale <span class="wintitle"> Libreria di informazioni sui dati</span> (DIL). </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>È stato aggiornato il <span class="wintitle"> Audience Optimization</span>rapporti con i rapporti Cross Channel Conversion (Conversione tra canali), Role-Based Access Control (Controllo dell’accesso in base al ruolo), Conversion Groups (Gruppi di conversione) e Reported Conversion Traits (Caratteristiche di conversione segnalate). </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>La <span class="wintitle"> Conversione tra canali</span> in <span class="wintitle"> Audience Optimization</span> I rapporti ti consentono di attribuire conversioni offline alle impression online o ai clic serviti. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Rimosso da <span class="keyword"> Audience Manager</span> documentazione a settembre 2017. Spostato in <span class="keyword"> Analytics</span> documentazione. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>È stato aggiornato per includere il passaggio di ID mobili con <code> d_cid</code>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md">Che cosa accade dopo la disattivazione dei miei feed dati da parte di un fornitore?</a> </p> </td> 
   <td colname="col2"> <p>Descrive un <span class="wintitle"> Audience Marketplace</span> l’acquirente dei dati può aspettarsi che un provider revochi l’accesso a un feed di dati. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> Codici errore DCS, messaggi ed esempi </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="1"> <p>Testo rivisto per includere il <code> d_mid</code> variabile. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nuova documentazione che elenca e definisce gli elementi in un <span class="wintitle"> Audience Marketplace</span> report di fatturazione. </p> </td> 
  </tr> 
  <tr> 
