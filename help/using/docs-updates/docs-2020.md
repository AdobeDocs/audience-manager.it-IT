...
|----|----|
| [Predictive Audiences](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Clonazione** predittiva del modello di pubblico: Ora puoi duplicare modelli esistenti e modificarne la configurazione in base alle tue esigenze. Leggi [Clonazione e modifica di modelli di pubblico predittivo](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) per ulteriori informazioni.</li><li>**Classificazione** Predictive Dei Batch Di Tipi Di Pubblico: Oltre a classificare i visitatori in persone distinte in tempo reale, Predictive Audiences ora supporta la classificazione in batch, aiutando a classificare gli utenti caricati e ad attivarli in destinazioni batch.</li></ul> |
| [Sovrapposizione di rapporti](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Abbiamo aggiornato la metodologia utilizzata per calcolare i report di sovrapposizione ([Trait-to-Trait](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [Segment-to-Trait](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [Segment-to-Segment](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). Il calcolo dei report di sovrapposizione ora si basa su univoche di reporting e firme MinHash (anziché su [1/54 data sampling](/help/using/reporting/report-sampling.md#data-sampling-ratio)). |
...
| [Nomi ](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) file S3 in entrata e nomi file FTP  [in entrata](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Abbiamo aggiornato le definizioni e fornito esempi per i campi `DPID` e `DPID_TARGET_DATA_OWNER` nella sintassi del nome del file. |

## Agosto 2020 {#aam-august-updates}

| Argomento | Descrizione |
|---- |----|
| [Corrispondenza cliente Google per destinazioni basate su persone](../features/destinations/people-based-destinations-prerequisites.md#gcm) | È ora possibile utilizzare [!UICONTROL People-Based Destinations] per eseguire il targeting degli utenti tramite [!DNL Google Customer Match]. Prima di poter utilizzare [!UICONTROL People-Based Destinations] per inviare segmenti di pubblico di prime parti a una [!DNL Google Customer Match] destinazione, è obbligatorio che [!DNL Google] ti aggiunga al loro elenco consentiti . Per ulteriori informazioni, consultare la documentazione [Destinazioni basate sulle persone](../features/destinations/people-based-destinations-prerequisites.md#gcm). |
