...
| [File ](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) in entrata S3 e nomi di file FTP  [in entrata](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Abbiamo aggiornato le definizioni e fornito esempi per i campi `DPID` e `DPID_TARGET_DATA_OWNER` nella sintassi del nome file. |

## Agosto 2020 {#aam-august-updates}

| Argomento | Descrizione |
|---- |----|
| [Customer Match di Google per le destinazioni basate su persone](../features/destinations/people-based-destinations-prerequisites.md#gcm) | È ora possibile utilizzare [!UICONTROL People-Based Destinations] per eseguire il targeting degli utenti tramite [!DNL Google Customer Match]. Prima di poter utilizzare [!UICONTROL People-Based Destinations] per inviare i segmenti di pubblico di prime parti a una destinazione [!DNL Google Customer Match], è obbligatorio che [!DNL Google] ti aggiunga al loro elenco consentiti. Per ulteriori informazioni, consulta la documentazione [Destinazioni basate sulle persone](../features/destinations/people-based-destinations-prerequisites.md#gcm) . |
