...
|----|----|
| [Predictive Audiences](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Clonazione del modello Predictive Audiences**: ora puoi clonare modelli esistenti e modificarne la configurazione in base alle tue esigenze. Letto [Clonazione e modifica di modelli di audience predittivi](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) per ulteriori informazioni.</li><li>**Classificazione in batch delle audience predittive**: oltre a classificare i visitatori in persone distinte in tempo reale, Predictive Audiences ora supporta la classificazione in batch, che consente di classificare gli utenti integrati e ad attivarli in destinazioni in batch.</li></ul> |
| [Rapporti di sovrapposizione](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Abbiamo aggiornato la metodologia utilizzata per calcolare i rapporti di sovrapposizione ([Rapporto caratteristica-caratteristica](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [Segmento per caratteristica](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [Segmento a segmento](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). Il calcolo dei rapporti di sovrapposizione ora si basa sul reporting di firme univoche e MinHash (anziché [Campionamento dei dati 1/54](/help/using/reporting/report-sampling.md#data-sampling-ratio)). |
...
| [Nomi file S3 in entrata](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) e [nomi file FTP in entrata](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Abbiamo aggiornato le definizioni e fornito esempi per `DPID` e `DPID_TARGET_DATA_OWNER` campi nella sintassi del nome file. |

## Agosto 2020 {#aam-august-updates}

| Argomento | Descrizione |
|---- |----|
| [Customer Match di Google per destinazioni basate su persone](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Ora puoi utilizzare [!UICONTROL People-Based Destinations] per eseguire il targeting degli utenti tramite [!DNL Google Customer Match]. Prima di usare [!UICONTROL People-Based Destinations] per inviare i segmenti di pubblico primario a una [!DNL Google Customer Match] destinazione, è obbligatorio che [!DNL Google] ti aggiunge al loro elenco consentiti. Controlla la [Destinazioni basate su persone](../features/destinations/people-based-destinations-prerequisites.md#gcm) per i dettagli. |
| [Nuovi server SFTP](../faq/faq-data-collection.md) | Ora puoi utilizzare il nuovo [!DNL SFTP] server ([!DNL ftp-in-gtw] e [!DNL ftp-out-gtw]) che utilizzano [!DNL AWS SFTP Gateway] oltre [!DNL S3]. |
