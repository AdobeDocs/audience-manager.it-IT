...
|----|----|
| [Predictive Audiences](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Clonazione del modello di Predictive Audiences**: Ora puoi clonare modelli esistenti e modificarne la configurazione in base alle tue esigenze. Leggi [Clonazione e modifica di modelli di audience predittivi](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) per ulteriori informazioni.</li><li>**Classificazione in batch di Predictive Audiences**: Oltre a classificare i visitatori in utenti tipo distinti in tempo reale, Predictive Audiences ora supporta la classificazione in batch, che consente di classificare gli utenti integrati e attivarli nelle destinazioni in batch.</li></ul> |
| [Rapporti di sovrapposizione](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Abbiamo aggiornato la metodologia utilizzata per calcolare i rapporti di sovrapposizione ([Trait-to-Trait](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [Segment-to-Trait](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [Segment-to-Segment](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). Il calcolo dei rapporti di sovrapposizione ora si basa sul reporting di firme univoche e MinHash (anziché [campionamento dei dati 1/54](/help/using/reporting/report-sampling.md#data-sampling-ratio)). |
...
| Argomento | Descrizione |
|---- |----|
| [Accessibilità in Audience Manager](/help/using/overview/accessibility-in-aam.md) | Accessibilità si riferisce a una serie di funzioni che rendono utilizzabile un prodotto software, con il minor sforzo possibile da parte di utenti con varie disabilità, come visive, uditive, cognitive, motori o di altro tipo. Per semplificare l’utilizzo degli Audienci Manager per tutti, abbiamo sviluppato il supporto per più funzioni di accessibilità, descritte in questo articolo. |
| [Nomi di file S3 in entrata](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) e [nomi di file FTP in entrata](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Abbiamo aggiornato le definizioni e fornito esempi per `DPID` e `DPID_TARGET_DATA_OWNER` campi nella sintassi del nome file. |

## Agosto 2020 {#aam-august-updates}

| Argomento | Descrizione |
|---- |----|
| [Customer Match di Google per le destinazioni basate su persone](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Ora puoi utilizzare [!UICONTROL People-Based Destinations] per indirizzare gli utenti tramite [!DNL Google Customer Match]. Prima di utilizzare [!UICONTROL People-Based Destinations] per inviare i segmenti di pubblico di prime parti a un [!DNL Google Customer Match] destinazione, è obbligatorio che [!DNL Google] ti aggiunge al loro elenco consentiti. Controlla la [Destinazioni basate su persone](../features/destinations/people-based-destinations-prerequisites.md#gcm) documentazione dettagliata. |
| [Nuovi server SFTP](../faq/faq-data-collection.md) | Ora puoi utilizzare il nuovo [!DNL SFTP] server ([!DNL ftp-in-gtw] e [!DNL ftp-out-gtw]) che utilizzano [!DNL AWS SFTP Gateway] over [!DNL S3]. |
...
| Argomento | Descrizione |
|---- |----|
| [Condivisione del pubblico tra Audience Manager e Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aep-aam-segment-population-differences) | La nuova sezione, **Comprendere le differenze di popolazione del segmento tra Audience Manager e Experience Platform**, descrive possibili ragioni per cui i numeri della popolazione possono variare tra Experience Platform e Audience Manager. |
| [Guida introduttiva alle API REST di Audience Manager](/help/using/api/rest-api-main/aam-api-getting-started.md#jwt) | Abbiamo aggiunto una nuova sezione, **Autenticazione JWT (account di servizio) tramite[!DNL Adobe I/O]**. Fai riferimento a questa sezione per l’autenticazione alle API di Audience Manager tramite [!DNL Adobe I/O]. |

## Giugno 2020 {#aam-june-updates}

| Argomento | Descrizione |
|---- |----|
| [Supporto di Audience Manager Data Export Control in Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aam-data-export-control-in-aep) | La nuova sezione dell&#39;articolo Condivisione del pubblico tra Audience Manager e Adobe Experience Platform include una mappatura tra i controlli di esportazione dei dati di Audience Manager e le etichette di utilizzo dei dati di Experience Platform. |
| [Audience Manager Plug-in for IAB TCF ](../overview/data-security-and-privacy/aam-iab-plugin.md) | Continuando a concentrare l’attenzione su Privacy by Design in Adobe, stiamo aggiornando il plug-in di Audience Manager per IAB TCF al Transparency &amp; Consent Framework (TCF) IAB versione 2.0 a partire dal 10 giugno 2020. I clienti che hanno implementato il plug-in di Audience Manager per IAB TCF devono effettuare l’aggiornamento alla versione 2.0 entro il 15 agosto 2020 per poter continuare a utilizzare la funzione. A partire dal 15 agosto 2020, la versione 1.1 diventerà obsoleta e non sarà più supportata. |
...
| [Inoltrare dati da Adobe Analytics ad Audience Manager](../integration/integration-other-solutions/audience-management-module.md) | Abbiamo aggiornato questa pagina per evidenziare Tag Adobe Experience Platform come metodo preferito per inoltrare i dati da Adobe Analytics ad Audience Manager. |
