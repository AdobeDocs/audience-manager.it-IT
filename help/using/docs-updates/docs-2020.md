...
| [Nuovi server SFTP](../faq/faq-data-collection.md) | Ora è possibile utilizzare i nuovi [!DNL SFTP] server (`ftp-in-gtw` e `ftp-out-gtw`) che utilizzano [!DNL AWS SFTP Gateway] oltre [!DNL S3]. |
