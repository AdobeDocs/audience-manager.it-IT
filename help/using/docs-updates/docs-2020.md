...
|----|----|
| [Predictive Audiences](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Clonazione** predittiva del modello di pubblico: Ora puoi duplicare modelli esistenti e modificarne la configurazione in base alle tue esigenze. Leggi [Clonazione e modifica di modelli](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) di audience predittivi per ulteriori informazioni.</li><li>**Classificazione** Predictive Dei Batch Di Tipi Di Pubblico: Oltre a classificare i visitatori in persone distinte in tempo reale, Predictive Audiences ora supporta la classificazione in batch, aiutando a classificare gli utenti caricati e ad attivarli in destinazioni batch.</li></ul> |
| [Sovrapposizione di rapporti](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Abbiamo aggiornato la metodologia utilizzata per calcolare i report di sovrapposizione ([Trait-to-Trait](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [Segment-to-Trait](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [Segment-to-Segment](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). Il calcolo Rapporti di sovrapposizione ora si basa su univoche di reporting e firme MinHash (anziché su [1/54 di campionamento](/help/using/reporting/report-sampling.md#data-sampling-ratio)dei dati). |
...
| [Nomi file](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) S3 in entrata e nomi file FTP [in entrata](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Abbiamo aggiornato le definizioni e fornito esempi per i `DPID` campi e i campi `DPID_TARGET_DATA_OWNER` nella sintassi del nome file. |
...
| [Nuovi server SFTP](../faq/faq-data-collection.md) | Ora è possibile utilizzare i nuovi [!DNL SFTP] server ([!DNL ftp-in-gtw] e [!DNL ftp-out-gtw]) che utilizzano [!DNL AWS SFTP Gateway] oltre [!DNL S3]. |
