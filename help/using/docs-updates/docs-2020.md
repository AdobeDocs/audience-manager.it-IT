...
| [Guida introduttiva alle API REST di Audience Manager](/help/using/api/rest-api-main/aam-api-getting-started.md#jwt) | È stata aggiunta una nuova sezione, Autenticazione **JWT (account di servizio) tramite[!DNL Adobe I/O]**. Fare riferimento a questa sezione per eseguire l&#39;autenticazione nelle API di Audience Manager utilizzando [!DNL Adobe I/O]. |

## Giugno 2020 {#aam-june-updates}

| Argomento | Descrizione |
|---- |----|
| [Supporto di Audience Manager Data Export Control in Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aam-data-export-control-in-aep) | La nuova sezione nell’articolo Condivisione di tipi di pubblico tra Audience Manager e Adobe Experience Platform include una mappatura tra i controlli di esportazione dei dati di Audience Manager e le etichette di utilizzo dei dati di Experience Platform. |
| [Audience Manager Plug-in for IAB TCF](../overview/data-security-and-privacy/aam-iab-plugin.md) | In linea con l’attenzione di Adobe per la Privacy by Design, a partire dal 10 giugno 2020 il plug-in Audience Manager per IAB TCF verrà aggiornato alla versione 2.0 del Transparency &amp; Consent Framework (TCF) di IAB. I clienti che hanno implementato il plug-in di Audience Manager per il TCF IAB devono effettuare l’aggiornamento alla versione 2.0 entro il 15 agosto 2020 per continuare a utilizzare la funzione. Dopo il 15 agosto 2020 la versione 1.1 diventerà obsoleta e non sarà più supportata. |
...
| [Inoltrare dati da Adobe Analytics ad Audience Manager](../integration/integration-other-solutions/audience-management-module.md) | Abbiamo aggiornato questa pagina per evidenziare Tag Adobe Experience Platform come metodo preferito per inoltrare dati da Adobe Analytics ad Audience Manager. |
